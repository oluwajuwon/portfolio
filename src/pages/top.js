                ...
                <div className="h-100">
                    <div className="row">
                        <div className="col-md-6 top__hero__info">
                            ...
                            <p>I have a knack for solving problems and making things look good. I believe in making the world a better place, one problem solution at a time.</p>
                        ...
                        <div className="col-md-6 p-4">
                            <img src="../images/coding.svg" className="img-fluid" alt="work icon"/>
                        </div>
                    </div>
                </div>
            </div>
